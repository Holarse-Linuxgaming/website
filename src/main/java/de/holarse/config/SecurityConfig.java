...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/articles/*/edit", "/wiki/*/edit").hasRole("USER")                   
                .antMatchers(HttpMethod.GET, "/articles/**", "/wiki/**").permitAll()                
                .antMatchers(HttpMethod.PUT, "/articles/*", "/wiki/*").hasRole("USER")                
                .antMatchers(HttpMethod.POST, "/articles/*", "/wiki/*").hasRole("USER")         
