...
@Component
@Qualifier("YOUTUBE")
public class YoutubeAttachmentRenderer implements AttachmentRenderer {
    ...
    public String render(final Attachment attachment) throws Exception {
        ...
        return renderEngine.execute("attachments/youtube.ftl", properties);
    }

    @Override
    public boolean canRender(final Attachment attachment) {
        return attachment.getAttachmentType().equals(AttachmentType.YOUTUBE);
    }
