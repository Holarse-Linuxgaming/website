...
public class W3cDateFormatter extends StdSerializer<OffsetDateTime> {
     ...
     */
    @Override
    public void serialize(final OffsetDateTime date, final JsonGenerator gen, final SerializerProvider arg2) throws IOException {
        gen.writeString(date.format(DateTimeFormatter.ISO_DATE_TIME));
    }
