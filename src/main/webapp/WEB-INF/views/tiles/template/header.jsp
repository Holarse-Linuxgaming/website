                            ...
                            <c:choose>
                                <c:when test="${not empty menuitem.children}">
                                    ...
                                    <li class="hs-has-mega-menu nav-item g-mx-20--lg" data-animation-in="fadeIn" data-animation-out="fadeOut" data-position="right">
                                        <a id="mega-menu-label-1" class="nav-link g-px-0" href="#" aria-haspopup="true" aria-expanded="false">${menuitem.label}
                                ...
                                <c:otherwise>
                                    <li class="nav-item g-mx-20--lg">
                                        <a href="${menuitem.url}" class="nav-link px-0">${menuitem.label}</a>
                                    </li>                                    
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
